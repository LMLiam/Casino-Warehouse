...
Casino Warehouse accepts changes through pull requests only. The `main` branch is protected, direct commits are blocked, and pull requests are merged with merge commits.
...
- Do not squash or rebase into `main`; maintainers merge pull requests with merge commits.
