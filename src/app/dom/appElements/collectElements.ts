...
export const collectElements = (): AppElements => {
  ...
  return {
    ...
    roomSocialUnread: query('#roomSocialUnread'),
    roomSocialFeed: query('#roomSocialFeed'),
    roomReactions: query('#roomReactions'),
    roomChatForm: query('#roomChatForm'),
    roomChatInput: query('#roomChatInput'),
    roomBrowser: query('#roomBrowser'),
    tableHost: query('#tableHost'),
    beatSettlementAnnouncement: query('#beatSettlementAnnouncement'),
    beatSeatStatus: query('#beatSeatStatus'),
    beatShoeStatus: query('#beatShoeStatus'),
    beatShoeLabel: query('#beatShoeLabel'),
    beatShoeCounts: query('#beatShoeCounts'),
    beatShoeMeter: query('#beatShoeMeter'),
    beatShoeCut: query('#beatShoeCut'),
    beatShoeCue: query('#beatShoeCue'),
    beatTableStatus: query('#beatTableStatus'),
    blackjackView: query('#blackjackView'),
    slotsView: query('#slotsView'),
    gameHud: query('#gameHud'),
    hudOverflowMenu: query('#hudOverflowMenu'),
    walletStack: query('.wallet-stack'),
    moneyPill: query('#moneyPill'),
    beatHalfChipIndicator: query('#beatHalfChipIndicator'),
