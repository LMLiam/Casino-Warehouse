...
import type { MultiplayerClient, RealtimeConnectionState } from '../../multiplayer/client';
import { protocolVersion, type RoomRole, type RoomSeatId, type RoomSnapshot, type RoomSummary } from '../../multiplayer/protocol';
