...
function asset(id: string, path: string, owner: string, category: AssetCategory, status: AssetStatus, source: AssetSource, dimensions: string, transparent = false): CasinoAsset {
  return {
    id,
    path,
    owner,
...
export const casinoAssets = {
  ...
  beatTheHouseTable: asset('beat-the-house.table', '/assets/beat-the-house/table.png', 'beat-the-house', 'table', 'approved-user-provided', 'user-provided', '1672x941'),
  beatTheHouseChips: asset('beat-the-house.chips', '/assets/common/chips-sheet.png', 'beat-the-house', 'chip-sheet', 'approved-user-provided', 'user-provided', '1536x1024', true),
  blackjackTable: asset('blackjack.table', '/assets/blackjack/table.png', 'blackjack', 'table', 'generated-final', 'imagegen', '1585x992'),
  gameTiles: {
    'beat-the-house': asset('lobby.tile.beat-the-house', '/assets/lobby/game-tiles/beat-the-house.png', 'lobby', 'game-tile', 'generated-final', 'imagegen', '1672x941'),
    ...
    'slots:thai-princess': asset('lobby.tile.thai-princess', '/assets/lobby/game-tiles/thai-princess.png', 'lobby', 'game-tile', 'generated-final', 'imagegen', '1672x941'),
  } satisfies Record<CasinoGameId, CasinoAsset>,
  slotFrames: {
    'thai-princess': asset('slots.thai-princess.frame', '/assets/slots/thai-princess/frame.png', 'slots', 'slot-frame', 'generated-final', 'imagegen', '1448x1086'),
  },
  slotSymbols: {
