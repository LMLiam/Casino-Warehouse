import { defaultSlotTheme, type SlotTheme } from './slots';
import { gameCatalogSchema } from '../schemas/casinoSchemas';
import type { CasinoGameId } from './ids';

export type { CasinoGameId } from './ids';
...
export const slotThemes: readonly SlotTheme[] = [defaultSlotTheme];
